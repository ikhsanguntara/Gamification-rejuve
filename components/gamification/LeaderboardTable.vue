<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6">
      ...
      >
        <span class="absolute -top-3 px-3 py-0.5 rounded-full bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs font-semibold shadow-sm">
          🥈 #2 Silver
        </span>
        <img
      ...
      >
        <span class="absolute -top-3 px-3 py-0.5 rounded-full bg-amber-800/20 dark:bg-amber-950 text-amber-800 dark:text-amber-300 text-xs font-semibold shadow-sm">
          🥉 #3 Bronze
        </span>
        <img
          ...
          <tbody class="divide-y divide-slate-100 dark:divide-slate-800/60 font-normal">
            ...
            >
              ...
              <td class="py-3.5 px-4 text-center font-semibold">
                <span
                  v-if="crew.rank === 1"
                  class="inline-flex w-6 h-6 rounded-full bg-amber-400 text-amber-950 items-center justify-center text-xs font-bold"
                >1</span>
                <span
                  v-else-if="crew.rank === 2"
                  class="inline-flex w-6 h-6 rounded-full bg-slate-300 text-slate-900 items-center justify-center text-xs font-bold"
                >2</span>
                <span
                  v-else-if="crew.rank === 3"
                  class="inline-flex w-6 h-6 rounded-full bg-amber-700 text-white items-center justify-center text-xs font-bold"
                >3</span>
              ...
              <td class="py-3.5 px-4">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="text-xs text-slate-400">{{ crew.position }}</span>
                  </div>
                </div>
              </td>
              ...
              <td class="py-3.5 px-4 text-center">
                <span class="px-2 py-0.5 rounded-md text-xs font-semibold bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300">
                  Lvl {{ crew.level }}
                </span>
              </td>
              ...
              <!-- Avg Score -->
              <td class="py-3.5 px-4 text-center font-medium text-slate-700 dark:text-slate-300">
                {{ crew.averageScore }}%
              </td>
