  ...
  <div class="space-y-4">
    ...
    <div class="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 shadow-sm">
      <div class="flex items-center justify-between mb-4">
        <div>
          <h4 class="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
        ...
        <div class="flex items-center gap-2">
          <span class="text-[10px] sm:text-xs font-bold px-2.5 py-0.5 rounded-full bg-[#499ec7]/10 text-[#24779f] dark:text-[#84cded]">
        ...
        >
          ...
          <div class="flex items-center justify-between mb-2">
            <div class="flex items-center gap-2">
              <!-- Icon indicator -->
              <div
                class="w-6 h-6 sm:w-7 sm:h-7 rounded-xl flex items-center justify-center text-xs font-bold"
            ...
            <!-- Status tag -->
            <span
              class="text-[9px] sm:text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider"
          ...
          <div class="my-1">
            ...
            <p class="text-[10px] sm:text-xs text-slate-400 dark:text-slate-500 mt-0.5 truncate">
