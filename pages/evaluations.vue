  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-white dark:bg-slate-900 p-4 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm">
      <div class="p-2 text-center sm:text-left">
        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Misi Minggu Ini</span>
      ...
      <div class="p-2 text-center sm:text-left">
        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Misi Diajukan</span>
        <p class="text-lg font-bold text-emerald-600 dark:text-emerald-400 mt-0.5 flex items-center justify-center sm:justify-start gap-1">
      ...
      <div class="p-2 text-center sm:text-left">
        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Belum Dinilai</span>
        <p class="text-lg font-bold text-amber-500 mt-0.5 flex items-center justify-center sm:justify-start gap-1">
          <Clock class="w-4 h-4" />
      ...
      <div class="p-2 text-center sm:text-left">
        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Perlu Revisi</span>
        <p class="text-lg font-bold text-rose-500 mt-0.5 flex items-center justify-center sm:justify-start gap-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      ...
      <div class="lg:col-span-4 space-y-3 lg:sticky lg:top-20">
        <div class="flex items-center justify-between gap-2 px-1">
          ...
          <span class="text-xs text-slate-400">Pilih misi untuk menilai</span>
        </div>
        ...
        <div class="space-y-2.5 max-h-[calc(100vh-280px)] overflow-y-auto pr-1">
          ...
          >
            ...
            <div class="mt-2 pt-2.5 border-t border-slate-100 dark:border-slate-800/60 flex items-center justify-between text-xs">
              ...
              <div class="flex items-center gap-2">
                <span v-if="m.averageScore > 0" class="font-semibold text-slate-800 dark:text-slate-200 text-xs">
                  {{ m.averageScore }}%
                </span>
                <StarReward
