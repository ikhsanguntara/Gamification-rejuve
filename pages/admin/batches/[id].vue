    ...
    <div v-else class="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 shadow-sm">
      <div class="flex items-center gap-3 pb-5 border-b border-slate-100 dark:border-slate-800">
        ...
        <div>
          ...
          <p class="text-xs text-slate-500 dark:text-slate-400">
            Perbarui data siklus batch, periode pelaksanaan, tema mingguan dinamis, dan sesuaikan anggota kru.
          </p>
        </div>
      </div>
      ...
      <form @submit.prevent="handleUpdate" class="space-y-6 pt-6">
        ...
        <div class="space-y-4">
          ...
          <!-- Pilihan Paket Template SOP Misi -->
        ...
        <!-- 2. Tema & Judul Siklus Mingguan Dinamis -->
        <div class="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
          <div class="flex items-center justify-between flex-wrap gap-2">
            <div>
              ...
              <p class="text-[11px] text-slate-400">Tampil pada kartu urutan Dashboard & Timeline kru</p>
            </div>
            <span class="text-[11px] font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-100 dark:bg-emerald-950/60 px-2.5 py-0.5 rounded-full">
              ✨ {{ form.weeks.length }} Minggu Terdaftar
            </span>
          </div>
          ...
          >
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <span class="text-[10px] font-bold text-slate-400 bg-slate-200/60 dark:bg-slate-700/60 px-1.5 py-0.2 rounded">
                  🔒 Template
                </span>
              </div>
              <input
                ...
                readonly
                disabled
                class="w-full text-xs font-semibold rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 px-3 py-2 text-slate-700 dark:text-slate-300 cursor-not-allowed select-all"
              />
            </div>
          </div>
        </div>

        <!-- 3. Penanggung Jawab Evaluasi & Approval (Desentralisasi per-Store Kru) -->
        <div class="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
          <div class="flex items-center justify-between">
            <h3 class="text-xs font-bold text-slate-400 uppercase tracking-wider">
        ...
        <!-- 4. Pilih Anggota Crew (Disaring: Kru Batch Ini / Belum Pernah Ikut & per-Gerai) -->
        <div class="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              ...
              <p class="text-[11px] text-slate-400">Pilih kru yang tergabung di dalam siklus batch ini dari berbagai gerai.</p>
            </div>
